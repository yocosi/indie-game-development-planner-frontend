...
<template>
  ...
  flex justify-between items-center">
    ...
    <div v-if="!user" class="header-menu-container flex justify-center items-center font-medium text-xl ml-36">
      <NuxtLink to="/">
      ...
      <NuxtLink to="/create-project">
        <p class="m-4 hover:underline underline-offset-8 hover:cursor-pointer hover:opacity-70">Create</p>
      </NuxtLink>
      <NuxtLink to="/projects">
        <p class="m-4 hover:underline underline-offset-8 hover:cursor-pointer hover:opacity-70">Projects</p>
      </NuxtLink>
    </div>
    <div v-else class="header-menu-container flex justify-center items-center font-medium text-xl ml-10">
      <NuxtLink to="/">
        <p class="m-4 hover:underline underline-offset-8 hover:cursor-pointer hover:opacity-70">Dashboard</p>
      </NuxtLink>
      <NuxtLink to="/create-project">
