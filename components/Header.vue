    ...
    <div class="header-form-container flex justify-center items-center">
      <form class="mx-4 h-12">
        ...
        <div class="relative">
          ...
          <input type="search" id="search" class="block w-full p-2.5 ps-10 text-sm font-medium text-gray-900 border border-gray-300 rounded-lg bg-gray-900
      ...
      <NuxtLink to="/login">
        <button class="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-blue-500 rounded-lg group bg-gradient-to-br from-cyan-500 to-blue-500
