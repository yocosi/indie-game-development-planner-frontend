...
<template>
  <div class="flex justify-center items-center flex-col mt-20 mb-32">
    ...
    <form @submit.prevent="signIn" class="border-2 border-gray-400 rounded-lg m-10 px-10 md:px-20 py-10">
      <div class="mb-10">
        <label for="email" class="block mb-2 text-lg font-medium text-gray-400 dark:text-white">E-mail</label>
        <input v-model="email" type="email" id="email" class="bg-gray-900 border border-gray-400 text-gray-400 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-72 md:w-96 p-2.5" required>
      </div>
      <div class="mb-10">
      ...
      pl-30 pr-30 py-2.5 text-center">Login</button>
      </div>
    </form>
  </div>
</template>