  ...
  <div class="flex justify-center items-center flex-col mt-20 mb-32">
    ...
    <form @submit.prevent="signUp" class="max-w-xl mx-auto border-2 border-gray-400 rounded-lg m-10 px-20 py-10 w-full">
      <div class="mb-5">
        ...
        <input v-model="username" type="text" id="username" class="bg-gray-900 border border-gray-400 text-gray-400 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-80 md:w-96 p-2.5" required>
      ...
      pl-30 pr-30 py-2.5 mr-7 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Sign-up</button>
      </div>
    </form>
  </div>
</template>
